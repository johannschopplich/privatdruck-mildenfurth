...
- **Baseline-Grid**: alle vertikalen Offsets leiten sich aus `--baseline = 11pt × 1.5` ab. Magic-mm-Werte vermeiden.
...
- **`app/assets/css/print.css` ist das Stylebook.** Vue-Components sind absichtlich headless (Struktur + Daten, keine `<style>` Blöcke). Typografische Änderungen passieren dort.
