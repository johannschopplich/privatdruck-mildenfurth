...
export const previousPublications: Publication[] = [
  ...
  { year: 2004, author: 'Wulf Kirsten', title: '„Besenginsterland"' },
  {
    year: 2005,
    author: 'Lutz Seiler',
    title: '„Vier neue Gedichte" mit einem Text von Wulf Kirsten als eingebundene Beilage des Essays „Die Anrufung"',
  },
  { year: 2006, author: 'Jan Volker Röhnert', title: '„Baltic Times"' },
  { year: 2007, author: 'Richard Pietraß', title: '„Wendekreis"' },
  { year: 2008, author: 'Guntram Vesper', title: '„Bullenbuch und Mordgeschichte"' },
  { year: 2009, author: 'Daniela Danz', title: '„Der Schlaf der Bagger"' },
  { year: 2011, author: 'Nancy Hünger', title: '„Es flüstert im inneren Ohr"' },
  { year: 2012, author: 'Uwe Grüning', title: '„Erinnerung an eine südliche Stadt"' },
  ...
  },
  {
    year: 2016,
    author: 'André Schinkel',
    title: '„Hasenberg. Vier Gedichte" erweitert um den Einleger „Als ich dich im Traum sah"',
  },
  ...
  { year: 2024, author: 'Christian Lehner', title: '„Augenblick am kristallinen Meer"' },
  { year: 2025, author: 'Romina Nikolić', title: '„Litanei der Leichtigkeit, in der du—"' },
]
